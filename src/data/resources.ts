...
const DATA = {
    ...
    'teacher': {
        ...
        code: {
            '3': Array(1).fill(null).map((_, i) => item(`Code GV L3 - Bài ${i + 1}`, THUMB_CODE, CODE_3, LINK_DL, "Khởi động tư duy lập trình")),
            '4': Array(1).fill(null).map((_, i) => item(`Code GV L4 - Bài ${i + 1}`, THUMB_CODE, CODE_4, LINK_DL, "Phát triển kỹ năng lập trình")),
            '5': Array(1).fill(null).map((_, i) => item(`Code GV L5 - Bài ${i + 1}`, THUMB_CODE, CODE_5, LINK_DL, "Dự án STEM ứng dụng")),
        },
        videos: {
            '3': Array(1).fill(null).map((_, i) => item(`Video Dạy L3 - Bài ${i + 1}`, THUMB_VID, VIDEO_3, LINK_DL, "Khởi động tư duy lập trình")),
            '4': Array(1).fill(null).map((_, i) => item(`Video Dạy L4 - Bài ${i + 1}`, THUMB_VID, VIDEO_4, LINK_DL, "Phát triển kỹ năng lập trình")),
            '5': Array(1).fill(null).map((_, i) => item(`Video Dạy L5 - Bài ${i + 1}`, THUMB_VID, VIDEO_5, LINK_DL, "Dự án STEM ứng dụng")),
        },
        ppt: {
